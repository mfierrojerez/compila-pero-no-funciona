...
function Noticias({jsonUrl="data/noticias/noticiasfake.json",imgBase="data/noticias/imagenes"}){
  ...
  return (
  <div className="nw-bs">
    {/* Controles arriba: Bootstrap puro */}
    ...
    {/* Carrusel Bootstrap (sin flechas embebidas) */}
                  ...
                  <div className="card h-100 shadow-sm border-0">
                    <div className="card-body py-3">
                      <div className="d-flex flex-column flex-md-row gap-3 align-items-start">
                        {/* Miniatura */}
                        <img
                          className="thumb-portrait img-fluid d-block"
                          src={(n.imagenes && n.imagenes.length>0) ? resolveImg(n.imagenes[0]) : undefined}
                          alt=""
                        />
                        {/* Texto */}
                        <div className="position-relative w-100">
                          <h5 className="mb-1">
                            <a
                              ...
                              onClick={e=>{e.preventDefault();openModal(n)}}
                            >
                              {n.titulo}
                            </a>
                          </h5>
      ...
      <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div className="modal-content">
          ...
          <div className="modal-body">
            {/* Galería: Carousel + botones abajo */}
            {current && current.imagenes && current.imagenes.length>1 ? (
              <>
                <div
                  id={`newsGallery-${current.id}`}
                ...
                <div className="d-flex justify-content-between">
                  <button
                    type="button"
                    className="btn btn-primary"
                    data-bs-target={`#newsGallery-${current.id}`}
                    data-bs-slide="prev"
                    aria-label="Anterior"
                  >
                    ‹ Anterior
